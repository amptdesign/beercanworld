...
$options[] = array(
    "name" => "Footer Featured Area Options",
    "type" => "sectionstart");
...
$options[] = array(
    ...
    'desc' => 'Cut Name of Post / Product in Breadcrumbs',
    'std' => '50',
...
$options[] = array(
    "name" => "Fonts info",
    "id" => "fonts-info",
    "text" => "If you want to use custom fonts, so please please read instructions in /css/custom_styles/readme.md file.",
    "type" => "info",
    "space" => false,
    "message" => "description"
);
...
$options[] = array(
    ...
    'type' => 'toggle',
    'name' => 'Show Banner ' . jwUtils::getHelp("", "BannerCustom.jpg"),
...
$options[] = array(
    "name" => "Imort DEMO",
    "id" => "info-demo-info",
    "text" => "<h3>Here you can see all 7 Styles.</h3><h3>Each style has variations, that can be changed in Settings -> Reading -> Frontpage. </h3>",
    "type" => "info",
    "space" => false,
    "message" => "warnings"
);
...
$options[] = array(
    "name" => "Import Sample Data (just click at image)",
    "space" => true,
    "id" => "import-sample-preset1",
    "file" => array("demo1", 'demo2', 'demo3', 'demo4','demo5','demo6','demo7'),
    "description" => array("Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>","Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>","Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>", "Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>", "Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>", "Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>", "Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>"),
    "img" => array("demo1.jpg", "demo2.jpg", "demo3.jpg", "demo4.jpg", "demo5.jpg", "demo6.jpg", "demo7.jpg"), //in /demo/images folder
    "type" => "importpreset"
);
...
$options[] = array(
    ...
    'type' => 'text',
    'name' => 'Number of Thumbnails per One Row',
...
$options[] = array(
    'id' => 'woo_social_share',
    'type' => 'toggle',
    'name' => 'Show Social Share in Product Details',
    'desc' => '',
    'std' => '1'
);
