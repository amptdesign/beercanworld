...
if (!class_exists('jwStyle')) {
    ...
    class jwStyle {
        ...
        private function get_custom_category_colors() {
            ...
            $css .= "h3.section-big {color: " . $template_color_1 . ";border-bottom: 1px solid " . $template_color_1 . ";font-size:" . $title_font_size . "px;}" . PHP_EOL;
            $css .= ".section-big-wrapper {border-bottom: 1px solid " . $template_color_2 . "}" . PHP_EOL;
            $css .= "h3.section-woo {color: " . $template_color_1 . ";border-bottom: 2px solid " . $template_color_1 . "}" . PHP_EOL;
            ...
            $css .= "#footer h3.section-big {border-bottom: 1px solid " . $footer_color_1 . ";color: " . $footer_color_1 . ";font-size:" . $footer_title_font_size . "px}" . PHP_EOL;
