                            ...
                            <div class="tab-pane fade <?php echo $register_c; ?>" id="tab_login_<?php echo jaw_template_get_counter('login'); ?>">
                                ...
                                <div class="registration-form-wrapper">
                                    ...
                                    if (isset($_POST['svalue']) && $_POST['svalue'] != jaw_template_get_var('answer', '2')) {
                                        ...
                                        echo do_shortcode('[jaw_message message_style="success" show_close="0" message_text="<strong>' . __('Congratulations you has been registered.', 'jawtemplates') . '</strong><br>' . __('Please check your e-mail box: ', 'jawtemplates') . REGISTERED_A_USER . '"]');
                                    }
                                    ?>
