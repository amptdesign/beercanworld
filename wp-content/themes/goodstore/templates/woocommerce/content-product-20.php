        ...
        <div class="box <?php echo esc_attr($class); ?>">
            ...
            <div class="product-box">
                ...
                <h2 class="<?php echo esc_attr(implode(' ', $class_rating)); ?>">
                    <a href="<?php echo esc_url($link); ?>" title="<?php echo esc_attr(get_the_title()); ?>" class="post_name"><?php echo jwUtils::crop_length(get_the_title(), jaw_template_get_var('letter_excerpt_title', jwOpt::get_option('letter_excerpt_title', -1))); ?></a>
                </h2>   <!-- Title -->
                <div class="rating <?php echo esc_attr(implode(' ', $class_rating)); ?>">
                    <?php echo $rating; ?>  <!-- RATING -->
                    <div class="clear"></div>
                </div>
                <?php echo jwUtils::crop_length(the_excerpt(), jaw_template_get_var('letter_excerpt', jwOpt::get_option('letter_excerpt', -1))); ?>  
